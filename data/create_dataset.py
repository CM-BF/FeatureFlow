...
def extract_frames(videos, inDir, outDir):
    ...
    for video in videos:
        ...
        retn = os.system('{} -i {} -vf scale={}:{} -vsync 0 -qscale:v 2 {}/%04d.png'.format('ffmpeg', os.path.join(inDir, video), args.img_width, args.img_height, os.path.join(outDir, os.path.splitext(video)[0])))
        if retn:
